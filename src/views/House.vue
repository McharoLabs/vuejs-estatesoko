<template>
  <div>
    ...
    <div class="p-4 sm:ml-64 justify-center flex">
      ...
      >
        EstateSoko Platform: House Details
    ...
    <section class="p-4 sm:ml-64 justify-center flex" id="house">
      <div
          ...
          <div class="grid lg:grid-cols-2 lg:gap-6 xl:grid-cols-3 mt-5">
            <div class="relative z-0 w-full mb-5 group">
              <input
                ...
                name="bedrooms"
                id="bedrooms"
                v-model="house_property_data.bedrooms"
            ...
            <div class="relative z-0 w-full mb-5 group">
              <input
                ...
                name="bathrooms"
                id="bathrooms"
                v-model="house_property_data.bathrooms"
            ...
            <div class="relative z-0 w-full mb-5 group">
              <input
                ...
                name="living_rooms"
                id="living_rooms"
                v-model="house_property_data.living_rooms"
            ...
            <div class="relative z-0 w-full mb-5 group">
              <input
                ...
                name="floors"
                id="floors"
                v-model="house_property_data.floors"
            ...
            <div class="relative z-0 w-full mb-5 group">
              <input
                ...
                id="garage_capacity"
                v-model="house_property_data.garage_capacity"
            ...
            <div class="relative z-0 w-full mb-5 group">
              <input
                ...
                name="yard_size"
                id="yard_size"
                v-model="house_property_data.yard_size"
            ...
            <div class="relative z-0 w-full mb-5 group">
              <input
                ...
                name="yard_type"
                id="yard_type"
                v-model="house_property_data.yard_type"
            ...
            <div class="relative z-0 w-full mb-5 group">
              <input
                ...
                name="balcony_size"
                id="balcony_size"
                v-model="house_property_data.balcony_size"
            ...
            <div class="relative z-0 w-full mb-5 group">
              <input
                ...
                name="corridor_size"
                id="corridor_size"
                v-model="house_property_data.corridor_size"
            ...
            <div class="relative z-0 w-full mb-5 group">
              <select
                ...
                v-model="house_property_data.furnishing_status"
            ...
            <div class="relative z-0 w-full mb-5 group">
              <input
                ...
                name="kitchen_count"
                id="kitchen_count"
                v-model="house_property_data.kitchen_count"
            ...
            <div class="relative z-0 w-full mb-5 group">
              <input
                ...
                name="kitchen_type"
                id="kitchen_type"
                v-model="house_property_data.kitchen_type"
            ...
            <div class="relative z-0 w-full mb-5 group">
              <input
                ...
                name="utilities"
                id="utilities"
                v-model="house_property_data.utilities"
            ...
            <div class="relative z-0 w-full mb-5 group">
              <input
                ...
                name="amenities"
                id="amenities"
                v-model="house_property_data.amenities"
            ...
            <div class="relative z-0 w-full mb-5 group">
              <input
                ...
                v-model="house_property_data.security_features"
            ...
            <div class="relative z-0 w-full mb-5 group">
              <input
                ...
                v-model="house_property_data.heating_cooling_systems"
            ...
            <div class="relative z-0 w-full mb-5 group">
              ...
              <label
                for="images"
                class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                >House pictures (At least 5)</label
              >
              <p
                v-if="errors.images"
                class="mt-2 text-sm text-red-600 dark:text-red-500"
...
import useHouseApi from "@/api/house";
...
export default defineComponent({
  ...
  setup() {
    ...
    const house_property_data = reactive({
      bedrooms: "",
      bathrooms: "",
      living_rooms: "",
      floors: "",
    ...
    const handleNumericInput = (field) => {
      if (isNaN(Number(house_property_data[field]))) {
    ...
    const handleImagesChanges = (event) => {
      ...
      if (files.length < 5) {
        ...
        errors.images = "";
        house_property_data.images = files;
      }
    };
    ...
    const isFormValid = () => {
      ...
      // Reset errors initially for house_property_data
      for (const key in house_property_data) {
        if (Object.prototype.hasOwnProperty.call(house_property_data, key)) {
          if (house_property_data[key] === "") {
      ...
      // Validate images
      if (house_property_data.images.length < 5) {
        errors.images = "Please upload at least 5 images.";
    ...
    const clearFormData = () => {
      ...
      // Clear house_property_data fields
      for (const key in house_property_data) {
        if (Object.prototype.hasOwnProperty.call(house_property_data, key)) {
          house_property_data[key] = "";
          errors[key] = ""; // Clear error
        }
      }
    };
    ...
    const handleOnSubmit = async () => {
      if (isFormValid()) {
        ...
        const {success, code, message} = await houseApi.create(formData);
